...
VISUAL_ACTION_SPECS: dict[str, VisualActionSpec] = {
    ...
    "Main_ClickParametersGCD": VisualActionSpec(
        name="Main_ClickParametersGCD",
        template="main/main_btn_parameters_usable.png",
        mode=VisualActionMode.BOX_CENTER_CLICK,
        expected_window_keyword="Chronopotentiometry Parameters",
        timeout_sec=1.5,
        retry_timeout_sec=2.5,
        max_attempts=2,
        allow_pipeline_fallback=True,
    ...
    "Techniques_SelectGCD_Selected_Check": VisualActionSpec(
        name="Techniques_SelectGCD_Selected_Check",
        template="techniques/techniques_item_gcd_selected.png",
        mode=VisualActionMode.DETECT_ONLY,
        state_only=True,
        require_full_window_roi=True,
        max_attempts=1,
    ...
    "Techniques_SelectGCD_Unselected_Check": VisualActionSpec(
        name="Techniques_SelectGCD_Unselected_Check",
        template="techniques/techniques_item_gcd_unselected.png",
        mode=VisualActionMode.DETECT_ONLY,
        require_full_window_roi=True,
        max_attempts=1,
        allow_pipeline_fallback=False,
    ),
    "Techniques_SelectGCD_Unselected_Click": VisualActionSpec(
        name="Techniques_SelectGCD_Unselected_Click",
        template="techniques/techniques_item_gcd_unselected.png",
        mode=VisualActionMode.BOX_CENTER_CLICK,
        require_full_window_roi=True,
        max_attempts=1,
    ...
    "CV_FocusInitialScanPolarity": VisualActionSpec(
        name="CV_FocusInitialScanPolarity",
        template="cv/cv_label_initial_scan_polarity.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "EIS_FocusAvgCycles_0p1_to_1Hz": VisualActionSpec(
        name="EIS_FocusAvgCycles_0p1_to_1Hz",
        template="eis/eis_label_avg_cycles_0p1_to_1hz.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "EIS_FocusAvgCycles_0p01_to_0p1Hz": VisualActionSpec(
        name="EIS_FocusAvgCycles_0p01_to_0p1Hz",
        template="eis/eis_label_avg_cycles_0p01_to_0p1hz.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_FocusCathodicCurrent": VisualActionSpec(
        name="GCD_FocusCathodicCurrent",
        template="gcd/gcd_label_cathodic_current.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_FocusAnodicCurrent": VisualActionSpec(
        name="GCD_FocusAnodicCurrent",
        template="gcd/gcd_label_anodic_current.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_FocusHighELimit": VisualActionSpec(
        name="GCD_FocusHighELimit",
        template="gcd/gcd_label_high_E_limit.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_FocusLowELimit": VisualActionSpec(
        name="GCD_FocusLowELimit",
        template="gcd/gcd_label_low_E_limit.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_FocusDataStorageIntvl": VisualActionSpec(
        name="GCD_FocusDataStorageIntvl",
        template="gcd/gcd_label_data_storage_intvl.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_FocusNumberOfSegments": VisualActionSpec(
        name="GCD_FocusNumberOfSegments",
        template="gcd/gcd_label_number_of_segments.png",
        mode=VisualActionMode.WINDOW_FIXED_COLUMN_ROW_CLICK,
        column_x1=286,
        column_x2=444,
        row_top_offset=2,
    ...
    "GCD_ClickOK": VisualActionSpec(
        name="GCD_ClickOK",
        template="gcd/gcd_btn_ok_usable.png",
        mode=VisualActionMode.BOX_CENTER_CLICK,
        max_attempts=1,
        allow_pipeline_fallback=False,
    ),
